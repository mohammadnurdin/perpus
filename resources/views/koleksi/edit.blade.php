                      ...
                      <form action="{{ route('koleksis.update' , $koleksi->id) }}"  method="POST">
                        ...
                        @method('PUT')
                          <div class="form-group row mt-3">
                              <label for="kd_koleksi" class="col-md-4 col-form-label text-right">kd_koleksi</label>
                              <div class="col-md-6">
                                    <input type="hidden" id="id" name="id" value="{{ $koleksi->id }}">
                                    <input type="text" id="kd_koleksi" class="form-control" name="kd_koleksi" required autofocus value="{{ $user->kd_koleksi }}">
                          ...
                          <div class="form-group row mt-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" id="hak_akses" name="hak_akses" aria-label="hak_akses">
                                    ...
                                    <option value="admin" {{ ( $user->hak_akses == "admin") ? "selected" : ""}}>Administrator</option>
                                    <option value="anggota"  {{ ( $user->hak_akses == "anggota") ? "selected" : ""}}>Anggota</option>
                                </select>
